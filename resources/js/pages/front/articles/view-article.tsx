...
function FrontArticleView() {
    const { article } = usePage<SharedData & { article?: IArticle | null }>().props;
...
FrontArticleView.layout = (page: ReactNode) => <FrontLayout>{page}</FrontLayout>;

export default FrontArticleView;
