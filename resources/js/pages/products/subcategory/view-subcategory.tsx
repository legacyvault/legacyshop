...
import { BreadcrumbItem, IStocks, ISubcats } from '@/types';
...
interface IDialog {
    ...
    //Inertia’s useForm
    data: IStockFormData;
    setData: (field: 'id' | 'sub_category_id' | 'remarks' | 'quantity', value: string) => void;
...
export default function ViewSubcategory() {
    ...
    const { subcat } = usePage().props;

    const selectedSubcat: ISubcats = subcat as ISubcats;
    ...
    const editSubmitHandler = (e: any) => {
        e.preventDefault();
        post(route('subcat.update-stock'), {
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="rounded-lg border border-border bg-card p-6 shadow-sm">
                            <div className="text-center">
                                ...
                                <div className="text-4xl font-bold text-primary">{selectedSubcat.total_stock}</div>
                            </div>
                        </div>
                        ...
                        <div className="rounded-lg border border-border bg-card p-6 shadow-sm">
                            ...
                            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <p className="text-lg font-semibold text-card-foreground">{selectedSubcat.name}</p>
                                </div>

                                {/* Description */}
                                <div className="space-y-2 md:col-span-2">
                                    <h3 className="text-sm font-medium tracking-wide text-muted-foreground uppercase">Description</h3>
                                    <p className="leading-relaxed font-semibold text-card-foreground">{selectedSubcat.description}</p>
                                </div>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <p className="text-xl font-bold text-primary">{selectedSubcat.discount} %</p>
                                </div>
                            </div>
                        </div>
