        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="min-h-screen bg-background p-6">
                <div className="space-y-6">
                    ...
                    <div className="rounded-lg border border-border bg-card p-6 shadow-sm">
                        <h2 className="mb-6 border-b border-border pb-2 text-xl font-semibold text-card-foreground">Product Information</h2>
                        ...
                        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                            ...
                            <div className="space-y-2">
                                <h3 className="text-sm font-medium tracking-wide text-muted-foreground uppercase">Sub Category Discount</h3>
                                <p className="text-lg font-semibold text-card-foreground">% Value</p>
                            </div>
                            ...
                            {/* Division Discount */}
                            <div className="space-y-2">
                                <h3 className="text-sm font-medium tracking-wide text-muted-foreground uppercase">Division Discount</h3>
                                <p className="text-lg font-semibold text-card-foreground">% Value</p>
                            </div>
                            ...
                            {/* Variant Discount */}
                            <div className="space-y-2">
                                <h3 className="text-sm font-medium tracking-wide text-muted-foreground uppercase">Variant Discount</h3>
                                <p className="text-lg font-semibold text-card-foreground">% Value</p>
                            </div>

                            {/* Price */}
                            <div className="space-y-2 md:col-span-2">
                                <h3 className="text-sm font-medium tracking-wide text-muted-foreground uppercase"> Base Price</h3>
                                <p className="text-xl font-bold text-primary">Rp. {formatRupiah('200000')}</p>
                            </div>

                            {/* Price */}
                            <div className="space-y-2 md:col-span-2">
                                <h3 className="text-sm font-medium tracking-wide text-muted-foreground uppercase"> Final Price</h3>
                                <p className="text-xl font-bold text-primary">Rp. {formatRupiah('100000')}</p>
                            </div>
                        </div>
                    </div>
